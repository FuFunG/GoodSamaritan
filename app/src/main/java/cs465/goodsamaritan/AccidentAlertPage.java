...
import cs465.goodsamaritan.helpers.DirectionsJSONParser;

public class AccidentAlertPage extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accident_alert_page);
        ...
        if (map != null) {
            ...
            LatLng dest = new LatLng(40.113878, -88.224893);
            LatLng origin = new LatLng(40.114871, -88.225015);
